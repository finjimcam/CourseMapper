...
from backend.models.models import User, PermissionsGroup, Course, LearningPlatform, LearningActivity, TaskStatus, LearningType
...
def populate_initial_data() -> None:
    ...
    with Session(engine) as session:
        ...
        activity_lecture = LearningActivity(id=1, name="Lecture", learning_platform_id=1)
        activity_lab = LearningActivity(id=2, name="Lab Session", learning_platform_id=2)
        ...
        session.add_all([
            ...
            user_admin, user_regular,
            course_math, course_physics,
            platform_online, platform_inperson,
            activity_lecture, activity_lab,
            status_pending, status_completed,
            type_homework, type_exam,
        ])
