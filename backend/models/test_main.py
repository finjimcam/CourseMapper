...
def test_create_session(client: TestClient, session: Session) -> None:
...
def test_workbook_crud(client: TestClient, session: Session) -> None:
...
class TestCreate:
    ...
    """
    # sqlalchemy.exc.IntegrityError: (sqlite3.IntegrityError) UNIQUE constraint failed: week.workbook_id, week.number
