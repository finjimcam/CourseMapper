          ...
          <div className="flex flex-col justify-between items-end gap-2">
            ...
            {ifCourseLead ? (
              <Link
                ...
                className="px-5 py-2.5 text-white hover:text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center"
              >
                Edit Workbook
              </Link>
            ) : null}
